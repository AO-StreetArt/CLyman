...
void Obj3::initialize_buffers()
{
	...
	scale_buffer = Vector3d::Constant(3, 1.0);
        location_buffer = Vector3d::Zero(3);
        rotatione_buffer = Vector3d::Zero(3);
        rotationq_buffer = Vector4d::Zero(4);
