...
SUB_OBJECTS = src/model/object_document.o src/model/animation_property.o src/api/json_object_list.o src/api/json_property_list.o core_database_manager.o property_database_manager.o obj3_database_manager.o
