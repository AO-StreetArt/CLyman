...
* Set up `Docker <https://www.docker.com/>`__ instances of `Mongo <https://mongodb.com/>`__, and `Consul <https://www.consul.io/>`__, and then populate the KV Store in `Consul <https://www.consul.io/>`__ with several configuration values.
